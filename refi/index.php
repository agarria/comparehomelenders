...
<head>
    ...
    <link rel="canonical" href="https://refiresults.com">
    <link rel="icon" type="image/jpg" href="favicon.png">
    <title>Refi Results</title>
    <meta property="og:url" content="https://refiresults.com">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Refi Results">
    <meta property="og:title" content="Refi Results">
    <meta property="og:description" content="This little known program gives homeowners access to cash.">
    <link rel="stylesheet" type="text/css" href="refiresults.css">
...
<body>
    <nav>
        <a href="https://refiresults.com/" class="logo">
        ...
        <div class="links">
            <span class="tag">
                ...
                <span class="rating">
                    <label class="official">US Rankings <span class="year"></span></label>
                    <div class="stars">
    ...
    <div id="overlay" class="overlay">
        <div class="form">
            ...
            <form>
                <div class="question">
                    <span class="question-name">Mortgage Type</span>
                    <input id="helper" type="hidden">
                    <input id="city" type="hidden">
                    <input id="state" type="hidden">
                    <input id="short" type="hidden">
                    <div class="buttons">
                        <span id="refinance" class="response default">Refinance</span>
                        <span id="purchase" class="response">Purchase</span>
                    </div>
                </div>
                <div class="question">
                    <span class="question-name">Credit Score:</span>
                    <div class="buttons score">
                        <span id="excellent" class="response">Excellent <small>(720 to 850)</small></span>
                        <span id="good" class="response default">Good <small>(690 to 719)</small></span>
                        <span id="fair" class="response">Fair <small>(630 to 689)</small></span>
                        <span id="poor" class="response">Poor <small>(300 to 629)</small></span>
                    </div>
                </div>
                <div class="question">
                    <span class="question-name">Loan Amount:</span>
                    <input type="range" id="loanamount" class="slider" min="50000" max="1000000" value="150000">
                    <span class="price" id="loanvalue"></span>
                    <button id="continue">Continue</button>
                </div>
                <div class="question">
                    <span class="question-name">Property Value:</span>
                    <input type="range" id="propertyvalue" class="slider" min="50000" max="1000000" value="250000">
                    <span class="price" id="propertyprice"></span>
                    <button id="filter">Show Results</button>
                </div>
            </form>
    ...
    <main>
        <header id="header">
            <div class="info">
                <span class="head">Top <i>Refi Results</i> In <span class="location"></span> <span class="year"></span></span>
                <span class="head-sub"><b>Review Mortgage Refi Results from Top Lenders In Your Area!</b><br><br>Search for top mortgage lenders and get refinance results in minutes.  Find a low rate, lower your monthly mortgage payment, take cash out and pay off your home fast.</span>
        ...
        <section class="list">
            <iframe id="results" scrolling="no" src="https://refiresults.com/results-refinance.html" sandbox="allow-forms allow-scripts allow-same-origin allow-presentation allow-top-navigation allow-popups"></iframe>
        </section>
        <div class="loans">
            <span class="big"><i class="fas fa-th-large"></i>Types of Mortgage Loans</span>
            <div class="chunk">
                <div class="loan">
                    <span class="type"><i class="fas fa-tag"></i>Purchase Loan:</span>
                    <span class="desc">
                ...
                <div class="loan">
                    <span class="type"><i class="fas fa-house-user"></i>Refinance Loan:</span>
                    <span class="desc">
            ...
            <div class="chunk">
                <div class="loan">
                    <span class="type"><i class="fas fa-home"></i>Home Equity Loan:</span>
                    <span class="desc">
                ...
                <div class="loan">
                    <span class="type"><i class="far fa-hand-point-left"></i>Reverse Mortgage Loan:</span>
                    <span class="desc">
        ...
        <footer>
            ...
            <span class="copy"><span class="year"></span> © <script>document.write(window.location.hostname); </script> All Rights Reserved</span>
        </footer>
    </main>
</body>
...
<script src="https://kit.fontawesome.com/4c9962e02c.js" crossorigin="anonymous"></script>
<script type="text/javascript">
    ...
    var value = document.getElementById("loanvalue");
    var amount = loan.value;
    value.innerHTML = format.format(amount);    
    ...
    var property = document.getElementById("propertyvalue");
    var price = document.getElementById("propertyprice");
    var dollar = property.value;
    price.innerHTML = format.format(dollar);    

    property.oninput = function() {
    ...
    document.getElementsByClassName("year")[1].innerHTML = new Date().getFullYear();
    document.getElementsByClassName("year")[2].innerHTML = new Date().getFullYear();
    ...
    $( document ).ready(function() {
        ...
        jQuery.get("https://ipinfo.io", function(response) {
            ...
            $("#helper").val(response.postal);
            $(".location").html(response.region);
            $(".region").html(response.city);
        ...
        $('#action').submit(function(event) {
            ...
            $(".overlay").toggleClass("auto");            
            return false;
        });

        $('#refinance,#purchase').click(function($event){
            $(".question:nth-child(1)").css('display','none');
            $(".question:nth-child(2)").css('display','block');
            $("#bar").css('width','50%');


            if ($event.currentTarget.id == 'refinance'){
                frame.src = "https://comparehomelenders.com/results-refinance.html";
            }
            if ($event.currentTarget.id == 'purchase'){
                frame.src = "https://comparehomelenders.com/results-purchase.html";
            }

            properties.zipcode = $("#helper").val();
        ...
        $('#filter').click(function($event){
            ...
            $(".question:nth-child(1)").css('display','block');

            properties.loanbalance = $("#loanamount").val();
            properties.propertyvalue = $("#propertyvalue").val();

            frame.src = frame.src + "?ZipCode="+properties.zipcode+"&State="+properties.state+"&creditscore="+properties.creditscore+"&loanbalance="+properties.loanbalance+"&propertyvalue="+properties.propertyvalue;
        });
    });
